...
@section('contents')
    <h1 class="mb-0">Add Peminjaman</h1>
            ...
            <div class="col-md-12 border-right">
                <div class="p-3 py-2">
                    ...
                    <div class="row mt-2">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="labels">Tanggal Mulai Penyewaan</label>
                                <input name="start_date" type="date"
                                    class="form-control form-control-user @error('start_date')is-invalid @enderror"
                                    id="start_date" placeholder="DD/MM/YYYY">
                                @error('start_date')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="labels">Tanggal Akhir Penyewaan</label>
                                <input name="end_date" type="date"
                                    class="form-control form-control-user @error('end_date')is-invalid @enderror"
                                    id="end_date" placeholder="DD/MM/YYYY">
                                @error('end_date')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
